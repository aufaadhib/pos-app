...
const paymentLabels = { CASH: "Tunai", QRIS: "QRIS", DEBIT_CARD: "Kartu debit", CREDIT_CARD: "Kartu kredit", BANK_TRANSFER: "Transfer bank" } as const;
