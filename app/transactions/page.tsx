...
export default async function TransactionsPage({ searchParams }: { searchParams: Promise<{ page?: string }> }) {
  ...
  const sales = await getSalesPage(outlet.id, page);
...
function paymentLabel(method: "CASH" | "QRIS" | "DEBIT_CARD" | "CREDIT_CARD" | "BANK_TRANSFER"): string {
  return { CASH: "Tunai", QRIS: "QRIS", DEBIT_CARD: "Debit", CREDIT_CARD: "Kredit", BANK_TRANSFER: "Transfer" }[method];
}
