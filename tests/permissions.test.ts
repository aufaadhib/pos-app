...
const expectations: Array<[AppRole, AppPermission, boolean]> = [
  ...
  ["owner", { transaction: ["correct"] }, true],
  ["manager", { transaction: ["correct"] }, true],
  ["cashier", { transaction: ["correct"] }, false],
  ["owner", { shift: ["forceClose"] }, true],
  ["manager", { shift: ["forceClose"] }, true],
  ["cashier", { shift: ["operate"] }, true],
  ["cashier", { shift: ["forceClose"] }, false],
  ...
  ["owner", { report: ["view", "export"] }, true],
  ["manager", { report: ["view", "export"] }, true],
  ["cashier", { report: ["view"] }, false],
  ["cashier", { report: ["export"] }, false],
  ...
  ["cashier", { settings: ["manage"] }, false],
  ["owner", { attendance: ["clock", "review", "correct", "viewReport", "export", "manage"] }, true],
  ["manager", { attendance: ["clock", "review", "correct", "viewReport", "export", "manage"] }, true],
